 ...
 */
public class TabFrag2_nearby extends BaseFragment {
    ...
    public static TabFrag2_nearby newInstance(String title, int indicatorColor, int dividerColor) {
        TabFrag2_nearby f = new TabFrag2_nearby();
        f.setTitle(title);
