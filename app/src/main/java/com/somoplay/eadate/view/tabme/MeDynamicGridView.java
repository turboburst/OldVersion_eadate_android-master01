...
import com.somoplay.eadate.view.Interfaces.MeDynamicGridAdapterInterface;
 ...
 */
public class MeDynamicGridView extends GridView {
    ...
    public MeDynamicGridView(Context context) {
        super(context);
        init(context);
    }

    public MeDynamicGridView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public MeDynamicGridView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private MeDynamicGridAdapterInterface getAdapterInterface() {
        return ((MeDynamicGridAdapterInterface) getAdapter());
    }
    ...
    private void handleCellSwitch() {
        ...
        for (Long id : idList) {
            ...
            if (view != null) {
                ...
                if ((aboveRight(targetColumnRowPair, mobileColumnRowPair)
                    ...
                    float xDiff = Math.abs(MeDynamicGridUtils.getViewX(view) - MeDynamicGridUtils.getViewX(mMobileView));
                    float yDiff = Math.abs(MeDynamicGridUtils.getViewY(view) - MeDynamicGridUtils.getViewY(mMobileView));
        ...
        if (targetView != null) {
            ...
            final MeDynamicGridAdapterInterface adapter = getAdapterInterface();
