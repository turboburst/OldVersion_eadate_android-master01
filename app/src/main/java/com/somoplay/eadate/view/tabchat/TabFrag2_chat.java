 ...
 */
public class TabFrag2_chat extends BaseFragment {
    ...
    public static TabFrag2_chat newInstance(String title, int indicatorColor, int dividerColor) {
        TabFrag2_chat f = new TabFrag2_chat();
        f.setTitle(title);
