 ...
 */
public class TabFrag3_favourite extends BaseFragment {
    ...
    public static TabFrag3_favourite newInstance(String title, int indicatorColor, int dividerColor) {
        TabFrag3_favourite f = new TabFrag3_favourite();
        f.setTitle(title);
