 ...
 */
public class TabFrag2_favourite extends BaseFragment {
    ...
    public static TabFrag2_favourite newInstance(String title, int indicatorColor, int dividerColor) {
        TabFrag2_favourite f = new TabFrag2_favourite();
        f.setTitle(title);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // return inflater.inflate(R.layout.fragment_tab_common, container, false);
        ...
        mRecyclerView = (RecyclerView) view.findViewById(R.id.recyclerView_people);
            ...
            public MyViewHolder(View view) {
                ...
                mTextView1.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        add(getAdapterPosition(), "add one item here ");
