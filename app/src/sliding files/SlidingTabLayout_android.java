...
package com.somoplay.eadate.view.tab_top_model;
...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private static final int TAB_VIEW_PADDING_DIPS_HORIZONTAL = 1;
    private static final int TAB_VIEW_PADDING_DIPS_VERTICAL = 11;
    ...
    private void populateTabStrip() {
        final TopTabFragmentPagerAdapter adapter = (TopTabFragmentPagerAdapter) mViewPager.getAdapter();
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            int paddingVertical = (int) (TAB_VIEW_PADDING_DIPS_VERTICAL * getResources().getDisplayMetrics().density);
            tabTitleView.setPadding(paddingHorizontal, paddingVertical, paddingHorizontal, paddingVertical);

            //text size
            tabTitleView.setTextSize(TypedValue.COMPLEX_UNIT_SP, TAB_VIEW_TEXT_SIZE_SP);
